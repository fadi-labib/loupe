...
The candidates, surfaced after the [Mongoose end-to-end validation](https://github.com/fadi-labib/loupe/blob/main/docs/plans/2026-05-16-mongoose-validation-gaplog.md) (gap log §F-10):
...
The candidates, surfaced after the [Mongoose end-to-end validation](https://github.com/fadi-labib/loupe/blob/main/docs/plans/2026-05-16-mongoose-validation-gaplog.md) (gap log §F-09):
