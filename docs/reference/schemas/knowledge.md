...
| `cross_references` | Per-asset map from asset to the threats / hazards / privacy concerns that touch it. Generated by `loupe verify`'s cross-reference check (planned). | n/a |
